			...
			div.row
				div.col-xs-12
					h2.section__title #[strong #3] demo
						code-pen(id="xezgmO")
					p.section__description vue-swiper with autoplay, fade effect and pause on hover

			div.row
				div.col-xs-12
					swiper(:nav-buttons="false" :autoplay-speed="5000" :speed="2500" fade pause-on-hover pause-on-dots-hover autoplay)
